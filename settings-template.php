...
$exhibitorEntryLevel[0]['description'] = 'This is a blank screen where you can add any introductory content for your end users. It is the first screen they will see when beginning the entry wizard process.';
...
$exhibitorEntryLevel[7]['description'] = 'This will be the Confirmation page after checkout, the final page of the wizard. Your end users will then be able to access the entire portal after completing the wizard.';
                           		...
                           		<form method="post" action="javascript:void(0);" onSubmit="exhibitor_entry_flow_settings_update()">
                           			<div class="form-group row">
                           				<div class="col-sm-3 ">
                           					...
                           					<p style="margin-top: 10px;">Wizard</p>
                           				</div>
                           				<div class="col-sm-3 ">
									...
									<div class="col-sm-6">
										...
										<?php if($levelData['name'] == "Intro"){?>
											...
											<? }else if($levelData['name'] == "Register"){?>
												<p class="eg-editlink"><a href="<?php echo site_url().'/content-editor/';?>" target="_blank">Update the Registration Form Here</a></p>
                                 ...
                                 <section class="faq-page-cats" Id="section_table" style="border-bottom:none;margin-bottom:30px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="faq-page-cat" >
                                                ...
                                                <div class="faq-page-cat-txt">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="dropdown-item" id="turn_the_users"><i class=" fa fa-eye-slash"></i> Assign Turn in Queue</a>
                                            ...
                                            <div class="col-md-3">
                                            <div class="faq-page-cat" >
                                                <div class="faq-page-cat-icon"><i class="bulkbtuton reporticon font-icon fa fa-opencart fa-2x"></i></div>
                                              ...
                                              $count=1;
                                                ...
                                                foreach($arr as $key=> $a_value) {
                                                  ...
                                                  if($a_value->turn=='')
                                                  {
                                                    ...
                                                    justify-content: flex-end;
                                                    width: 223px;
                                                    margin-top: -54px'><input type='checkbox' name='active_close_check'  data-on='Open' data-off='Close' ".$status." id='User_PRI_Btn".$a_value->Id."' value='checked' data-toggle='toggle' data-size='xs'> </td>";
...
jQuery("#turn-counter").html('<?php echo json_encode($currentturnnumnber); ?>');   
      ...
      jQuery('#toggle_btn').on('click',function () {
        ...
        else if(val=='checked')
        {
          ...
          if(jQuery('#exhibitorentryflow').prop('checked')){
                  swal({
                            title: "Entry Wizard is Enabled",
                            text: 'Kindly Disable the Entry Wizard for Enable Queue',
                            // type: "success",
                            html:true,
                            confirmButtonClass: "btn-danger",
                   ...
                   closeIcon: true,
                         ...
                         confirm: function () {
                          var selectedtemplateemailname=[];
                             selectedtemplateemailname = jQuery( "#UserSelected" ).val();
                             ...
                             if(selectedtemplateemailname!=undefined)
                              {
                                   ...
                                   selectedtemplateemailname.forEach(element => {
                                  console.log(element);   
