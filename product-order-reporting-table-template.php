...
<div class="col-sm-10" style="margin-left: 300px; margin-bottom: -39px; "> <a class="btn btn-lg mycustomwidth btn-success" href="<?php echo $site_url?>/create-new-order/" role="button">Create New Order</a>
</div>
</div>
