...
function add_new_product_package(){
   ...
   // var visiblelevels = jQuery('#visiblelevels').select2("val");
    ...
    var url = currentsiteurl+'/';
    var urlnewproduct = url + 'wp-content/plugins/EGPL/orderreport.php?contentManagerRequest=addnewproductpackages';
    var urlupdateproduct = url + 'wp-content/plugins/EGPL/orderreport.php?contentManagerRequest=updateproductpackages';
