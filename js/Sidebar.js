...
Sidebar.prototype.addExhibitorsFunctions = function(graph, id, title, expanded, fns,condition)
{
	...
	{           
                                            ...
                                            if(boothproductid !=""){
                                                ...
                                                jQuery.ajax({
                                                    ...
                                                    success: function(data) {
                                                        ...
                                                        htmlforproductdetail += "<div class='row'><div class='col-sm-6'><p><a href='"+baseCurrentSiteURl+"/product/"+finalresultProduct.slug+"' target='_blank'><h2>"+finalresultProduct.title+"</h2></a></p><p><strong>Price : "+finalresultProduct.price+"</strong></p></div><div class='col-sm-3'><p style='text-align:center;'><img width='130' src='"+finalresultProduct.src+"'></p></div></div><hr>";
                                                      
                                                        htmlforproductdetail += "<p>"+finalresultProduct.description+"</p><hr>";

                                                        if(finalresultProduct.stockstatus == 'instock'){

                                                            htmlforproductdetail += "<p style='float:right;'><a class='btn btn-small btn-info' onclick='addToCart('"+boothproductid+"') >ADD TO CART</a></p>";
                                                        }else{

                                                            htmlforproductdetail += "<p style='float:right;'><strong style='color:red'>Stock Out</strong></p>";
                                                        }

                                                       var imagesrc = "<div class='row'><div class='col-sm-6'><p><h2>"+index.companyname+"</h2></a></p></div><div class='col-sm-3'><p style='text-align:center;'><img width='130' src='"+companylogourlnew+"' /></p></div></div><hr>";
       ...
       function addToCart(p_id) {
          jQuery.get(baseCurrentSiteURl+'?add-to-cart=' + p_id, function() {
