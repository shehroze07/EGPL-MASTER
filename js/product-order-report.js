            ...
            jQuery.each(columsheader, function (key, value) {
               ...
               // console.log(columsheader[key]);
                ...
                if(columsheader[key].data == 'Products List' ){
                    ...
                    columnsheaderarrayfortable.push({visible:true,title: columsheader[key].title, data: columsheader[key].title, type: columsheader[key].type});
                        ...
                        if (oData[key].filteroperator == 'between') {
                            ...
                            jQuery.fn.dataTable.ext.search.push(
                                    function (settings, data, dataIndex) {
                                        ...
                                        //var gettimecol = new Date(datetime[1] + "-" + datetime[0] + "-" + datetime[2]).getTime();
                                        var gettimecol = datetime[1] + "-" + datetime[0] + "-" + datetime[2];
