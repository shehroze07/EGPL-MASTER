    ...
    if (mxCurrentfloorplanstatus == "viewer") {
      ...
      this.editor.graph.addListener(mxEvent.CLICK, function (sender, evt) {
        ...
        if (
          ...
          logInUser["OverrideBoothLimit"].length > 0 &&
          logInUser["OverrideBoothLimit"][0] != " "
        ) {
          userlimit = logInUser["OverrideBoothLimit"][0];
        } else {
                      ...
                      if (productstatus == "alreadyexistproduct") {
                        ...
                        if (
                          ...
                          if (
                            ...
                            parseInt(logInUser["priorityNum"]) >= 1 &&
                            logInUser["turn"] &&
                            logInUser["turn"][0] == "Checked" &&
                            logInUser["status"] &&
                          ...
                          if (
                            ...
                            if (userloggedinstatus == true) {
                              if (productstatus == "alreadyexistproduct") {
                                ...
                                if (flowstatus.indexOf("mood=wizard") != -1 &&   reservedStatus == "") {
                                  buttonsdiv =
                                    '<div class="row footerdivfloorplan" style="margin-bottom: 25px;background: #fff;"><div class="col-sm-12" id=' +
                                    postid +
                              ...
                              if (flowstatus.indexOf("mood=wizard") != -1) {
                                if (productstatus == "alreadyexistproduct" &&   reservedStatus == "") {
                                  buttonsdiv =
                                    '<div class="row footerdivfloorplan" style="margin-bottom: 25px;background: #fff;"><div class="col-sm-12" id=' +
                                    postid +
                                    ' style="text-align: center;"><a class="btn btn-success btn-small" >Added</a><p style="font-size: 14px;margin-top: 10px;color: #005e00;"><b>This Booth is included in your current selected package.</b></p></div></div>';
                                ...
                                if (
                                  ...
                                  if (
                                    ...
                                    buttonsdiv =
                                      ...
                                      '_checkout" href="' +
                                      checkouturl +
                                      '" target="_blank" disabled="true" >Check Out</a></div>';
                                  }
                            ...
                            if (flowstatus.indexOf("mood=wizard") != -1) {
                              if (
                                ...
                                buttonsdiv =
                                  ...
                                  finalresultProduct.slug +
                                  ')">Pay in Full</a></div></div></div></div>';
                              } else   if (productstatus == "alreadyexistproduct") {  
                                buttonsdiv =
