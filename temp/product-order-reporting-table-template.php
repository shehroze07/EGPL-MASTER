            ...
            <div class="tab-content">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <select style="width:100%;height:38px;" class="form-control"
                                                onchange="loadorderreport('')" id="loadorderreport" egid="loadorderreport">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input style="height: 38px;" placeholder="Report Name"
                                                        id="orderreportname" type="text" class="form-control" egid="orderreportname" required>
                                                    <div class="input-group-btn">
                                                        <button type="button" class="btn dropdown-toggle"
                                                            data-toggle="dropdown" aria-haspopup="true"
                                                            aria-expanded="false"  egid="action">
                                                            Action
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <button type="submit" name="saveorderreport"
                                                                class="dropdown-item" egid="save-order-report"><i class="font-icon fa fa-save"
                                                                    aria-hidden="true"></i> Save</button>
                                                            <a class="dropdown-item" onclick="removeeorderreport()" egid="delete-order-report"><i
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select class="select2" data-placeholder="Select Columns" title="Select Columns"
                                ...
                                multiple="multiple" egid="orderreportcolumns">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select class="select2" data-placeholder="Select Columns" id="orderbycolumnsname"
                                data-allow-clear="true"  egid="orderbycolumnsname">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6" style="text-align: left;">
                            ...
                            <button class="btn btn-lg mycustomwidth btn-success"
                                onclick="request_getapplyfiltersonordereport()" egid="run-report">Run Report</button>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="tabs-1-tab-1">
                    <div class="form-group row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <select style="width:100%;height:38px;" class="form-control"
                                                        onchange="customeloadorderreport()" id="customeloadorderreport" egid="customeloadorderreport">
                                                        <option disabled selected hidden>Load a Report</option>
                        ...
                        <div class="col-sm-3">
                            ...
                            <button style="margin-top: 9px !important;"
                                class="btn btn-lg mycustomwidth btn-success backtofilter" egid="customized-report">Customize Report</button>
                    ...
                    <div class="col-sm-8" style="display:flex;">
                          ...
                          <a onclick="customeloadorderreportLink('All')" style='   margin-left: 20px'>All</a>
                          <a onclick="customeloadorderreportLink('Paid in Full')" style='   margin-left: 20px'>Paid in Full</a>
                          <a onclick="customeloadorderreportLink('Balance Due')" style='   margin-left: 20px'>Balance Due</a>
                          <a onclick="customeloadorderreportLink('Initial Deposit Paid')" style='   margin-left: 20px'>Initial Deposit Paid</a>
                          <a onclick="customeloadorderreportLink('Cancelled')" style='   margin-left: 20px'>Cancelled</a> 
                          <a onclick="customeloadorderreportLink('Refunded')" style='   margin-left: 20px'>Refunded</a>
                          <a onclick="customeloadorderreportLink('Failed')" style='   margin-left: 20px'>Failed</a>
...
<script type="text/javascript" src="/wp-content/plugins/EGPL/js/product-order-report.js?v=4.6"></script>
