...
<div class="page-content">
        <div class="container-fluid">
            ...
            <div class="box-typical box-typical-padding">
                ...
                <div class="form-group row">
                    ...
                    <table  id="bulkedittasktable" class="table-bordered compact dataTable no-footer cards"  width="100%">
                            <thead>
                                <tr class="text_th" >
                                    <th >Action</th>
                                    <th >Title</th>
        ...
        <script type="text/javascript" src="/wp-content/plugins/EGPL/js/bulk_edit_task.js?v=3.79"></script>    
