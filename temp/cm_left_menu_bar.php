            ...
            <div class="site-header-content">
	            ...
	            -->
                    ...
                    <div class="toast-fixed">
                        <div class="js-toast-container">
                            <div class="toast toast--error toast--dismiss">
                                <p class="toast__text">Important: Your floor plan is currently locked since you haven't
                                    properly exited the editor. It is recommended to go back to the editor and click
                                    "Exit" to prevent any live floor plan conflicts.</p>
                            </div>
                        </div>
                    </div>
                    <?php }?>
                    <div class="site-header-collapsed">
                        <div class="site-header-collapsed-in">
                            ...
                            <div class="dropdown" style="margin-top: 5px;">
                                <button class="btn btn-rounded dropdown-toggle" id="dd-header-add" style="width: 100px;"
                                ...
                                <div class="dropdown-menu dropdown-menu1" aria-labelledby="dd-header-add">
                                    ...
                                    <a class="dropdown-item" target="_blank"
                                        href="https://expo-genie.com/release-notes/">
                            ...
                            <div class="dropdown" style="margin-top: 5px;margin-right: 4px;">
                                <button class="btn btn-rounded dropdown-toggle" style="width: 100px;" id="dd-header-add"
                                    type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Portals
                                </button>
                            ...
                            <div class="dropdown" style="margin-top: 5px;margin-right: 4px;">
                                <button class="btn btn-rounded " id="btn-help" onclick="embadhelpvidoe()" type="button"
                                    style="width: 100px;height: 30px;padding: 0 12px; font-size: .8125rem;line-height: 28px;">
                            ...
                            <div class="dropdown" style="margin-top: 5px;margin-right: 4px;">
                                <button class="btn btn-rounded " id="btn-contact" onclick="contact_us()" type="button"
                                    style="width: 140px;height: 30px;padding: 0 12px; font-size: .8125rem;line-height: 28px;">
                            ...
                            <div class="">
                                <h6 style="text-align: left;color:#000;margin-top: 10px;font-weight: bolder;">
                                    ...
                                    <a style="color:#000;" href="<?php echo $site_url; ?>"
                                        target="_blank"><?php echo $blog_title;?></a>
            ...
            <ul class="mynav">
                ...
                <li class="mythemestyle">
                    <a href="<?php echo $site_url; ?>/floor-plan-editor/" target="_blank">
                        ...
                        <span class="lbl menumargine">Floor Plan Editor </span><i style="color:black;left:170px;"
