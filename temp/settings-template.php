        ...
        else if(val=='checked')
        {
          ...
          if(jQuery('#exhibitorentryflow').prop('checked')){
                  swal({
                            ...
                            text: 'You cannot enable the Booth Selection Queue while Registration is live. Please disable Registration first if you wish to go live with the turn-based Booth Selection.',
                            // type: "success",
                            html:true,
                            confirmButtonClass: "btn-danger",
