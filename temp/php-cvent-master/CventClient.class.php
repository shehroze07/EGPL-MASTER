...
class CventClient extends SoapClient {
	...
	public function Login($acct, $username, $password) {
		$this->client = new SoapDebugClient("https://sandbox-api.cvent.com/soap/V200611.ASMX?WSDL", array('trace' => true, 'exceptions' => true));
		$cache = true;
	...
	public function SearchContactBySourceId($remaxId) {
		$response = $this->SearchByFilter('Registration', 'AndSearch', array((object) array('Field' => 'EmailAddress', 'Operator' => 'Equals', 'Value' => $remaxId)));
