<?php 
if (current_user_can('administrator') || current_user_can('contentmanager') || current_user_can('speakers') || current_user_can('exhibitor')){
...
jQuery("#main>div").css("max-width","100%");

</script>

<?php }else if(current_user_can('attendee')){
    
    
    $site_url = get_site_url();
    wp_redirect( $site_url.'/live/'); exit;
}else{?>
