...
<script type="text/javascript" src="/wp-content/plugins/EGPL/cmtemplate/js/lib/lobipanel/lobipanel.min.js?v=2.95">
</script>
<script type="text/javascript"
    src="/wp-content/plugins/EGPL/cmtemplate/js/lib/match-height/jquery.matchHeight.min.js?v=2.95"></script>
...
<!---             Order-Managemnt    -->
<script type="text/javascript" src="/wp-content/plugins/EGPL/js/ordermanagment/create-new-order.js?v=3.23"></script>
<script type="text/javascript" src="/wp-content/plugins/EGPL/js/ordermanagment/edit-order.js?v=1.16"></script>
<!---             Order-Managemnt    -->
...
<script type="text/javascript" src="/wp-content/plugins/EGPL/js/bulk-email.js?v=2.005"></script>
...
<script type="text/javascript" language="javascript" src="/wp-content/plugins/EGPL/js/dataTables.buttons.min.js?v=2.95">
</script>
<script type="text/javascript" language="javascript" src="/wp-content/plugins/EGPL/js/jszip.min.js?v=2.95"></script>
<script type="text/javascript" language="javascript" src="/wp-content/plugins/EGPL/js/buttons.html5.min.js?v=2.95">
</script>
...
<script src="https://cdn.tiny.cloud/1/x3dc2egolhkv6of9uh5wz8868qqa8wnd4adprpvr452tyd41/tinymce/5/tinymce.min.js"
...
jQuery('a[href="' + window.location.protocol + "//" + window.location.host + this.location.pathname + '"]').parents(
    'li').addClass('active');
jQuery('a[href="' + window.location.protocol + "//" + window.location.host + this.location.pathname + '"]').parents(
    'li').parent('ul').parent('li').removeClass('active');
if (this.location.pathname != '/dashboard/') {
    jQuery('.opened').removeClass('opened');
    jQuery('a[href="' + window.location.protocol + "//" + window.location.host + this.location.pathname + '"]').parents(
        'li').parent('ul').parent('li').addClass('opened');
}
jQuery(".mynav li a").on("click", function() {
    jQuery('.opened').addClass('opened');
    jQuery('.active').removeClass('active');
    jQuery('a[href="' + window.location.protocol + "//" + window.location.host + this.location.pathname + '"]')
...
jQuery(document).ready(function() {
    ...
    jQuery(".toast--dismiss").click(function() {
